...
//useful constructor
SinricSwitch::SinricSwitch(const char* apiKey, String device_id, unsigned int port, CallbackFunction toggleCB, CallbackFunction alertCB, CallbackFunction resetCB){
    deviceID = device_id;
...
void SinricSwitch::setPowerState(boolean newState) {
