...
#define CURRENT_FLOW_NONZERO_THRESHOLD 50
...
void setup() {
  ...
  if(wifiConnected){
    ...
    lightOne = new Switch(alexaCommandOne, 80, lightsOnOne, lightsOffOne, moduleReset);
    lightTwo = new Switch(alexaCommandTwo, 88, lightsOnTwo, lightsOffTwo, moduleReset);
...
void lightsOnTwo() {
    ...
    lightTwo->setState(lightStateTwo);
